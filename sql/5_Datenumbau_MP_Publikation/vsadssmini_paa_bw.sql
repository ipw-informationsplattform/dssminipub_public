  ...
  SELECT
    ...
    CASE
      WHEN k.finanzierung = 'oeffentlich' THEN
        CASE 
          WHEN k.nutzungsart_geplant = 'entlastetes_Mischabwasser' THEN 'A_Entl'
          WHEN k.nutzungsart_geplant = 'Mischabwasser' THEN 'A_MA'
          WHEN k.nutzungsart_geplant IN ('Schmutzabwasser','Industrieabwasser') THEN 'A_SA'
          WHEN k.nutzungsart_geplant IN ('Reinabwasser','Niederschlagsabwasser') THEN 'A_RA'
          WHEN k.nutzungsart_geplant IN ('andere','unbekannt','Bachwasser') THEN 'A_unbekannt'
        END
    END AS stilid
...
INSERT INTO se_mp_pub.paa_bw (eigentuemer_organisationstyp, finanzierung, funktionhierarchisch, nutzungsart_ist, nutzungsart_geplant, detailgeometrie, oid_dss, astatus, stilid)
  SELECT
