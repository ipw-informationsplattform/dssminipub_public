 ...
 * INTERLIS Zielmodell :  SO_AFU_VSADSSMINI_EP_Publikation_20230331 
...
mangel_l AS (
  ...
  LEFT JOIN (
    ...
    FROM se_ep_pub.paa_leitung_se) u
    ON l.t_ili_tid = u.oid_dss
    WHERE l.funktionhierarchisch LIKE 'PAA.%'
    AND l.funktionhydraulisch NOT IN ('Drainagetransportleitung', 'Sickerleitung')
)

INSERT INTO se_ep_pub.mangel_leitung  (oid_dss, verlauf, beschreibung, stilid)
  SELECT
    t_ili_tid,
    verlauf,
